...
const Bar = () => {
    ...
    return (
        <Box m="20px">
            <Header title="Revenue" subtitle="Revenue statistics by month, quarter, year" />
            <Box height="75vh">
                ...
                <BarChart data={revenue} day={day} month={month} year={year} filter={filter} fromDay={fromDay} />
            </Box>
            <ToastContainer />
        </Box>
    );
